About digitalearth-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/digitalearth-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/serapeum-org/Digital-Earth
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/digitalearth-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/digitalearth-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
Installing `digitalearth` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
```
mamba search digitalearth --channel conda-forge
```
...
mamba repoquery search digitalearth --channel conda-forge

# List packages depending on `digitalearth`:
mamba repoquery whoneeds digitalearth --channel conda-forge

# List dependencies of `digitalearth`:
mamba repoquery depends digitalearth --channel conda-forge
```
...
Updating digitalearth-feedstock
===============================

If you would like to improve the digitalearth recipe or build a new
...
Note that all branches in the conda-forge/digitalearth-feedstock are
